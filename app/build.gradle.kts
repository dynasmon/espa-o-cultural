...
dependencies {
    ...
    implementation(platform("com.google.firebase:firebase-bom:32.1.1")) // Define a versão do Firebase
    implementation("com.google.firebase:firebase-auth-ktx") // Autenticação Firebase
